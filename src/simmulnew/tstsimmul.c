...
*                    single wavelength excitation 0.2 Aengstrom
*
*                    M.Bos
...
/* debugging
 printf("Voor pilamba i is %d en intens %g \n",i, (pntrspectrum[i]).intens); /* */ 
  ...
  printf("totint na intra %g totint_bulk %g \n", totint, totint_bulk); /* */
        ...
        {
           /* debugging 
           dummy = intersecflu(el, lin, labda_in, &sample, k, l, primint);
           printf("dummy l < k : l %d %g \n",l, dummy);
           totint += dummy; /* */
        ...
        {  /* debugging 
           dummy = intersecflu(el, lin, labda_in, &sample, k, l, primint);
           printf("Dummy l < nr_layers l %d %g \n",l,  dummy);
           totint += dummy; /* */
           totint += intersecflu(el, lin, labda_in, &sample, k, l, primint); 
           l++ ;
        }
