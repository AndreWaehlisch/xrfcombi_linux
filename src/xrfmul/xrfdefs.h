...
int iter, maxiter, nparm, nvert, ndata, nfree, nr_free_vars ;
...
double quad_test, test, ypmin, yzero ;
int quad_cycle, nquad_skip, maxquad_skip ;
struct qstruct q ;
double  ymin,  mse ;
...
double *kvlines ;
double *rxi_meas, *rxi_calc, *intbulk_calc, *intprep_calc ;
