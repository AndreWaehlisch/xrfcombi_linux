...
double intrasecflu(char *meas_elem, char *meas_line, double lambda,
                   ...
                   int line_index, int lambda_index)
{
   int i, nr_enh, z_enh;
   char el_enh[3];
   elem_line *pline;
   ...
   if (primint ==0.0) return(0.0); /* easily done */
   /* first check is line is fluoresced, if not no enhancement */
