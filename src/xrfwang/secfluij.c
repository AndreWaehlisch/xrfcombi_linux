...
double secijlambda( double Cj, double Jjlambda, double omegaj,
...
double sijlambda(char *el_i, char *el_j, char *line_i, char *line_j,
                 layer *ptop, double lambda, double Pilambda, int line_index,
                 int lambda_index)
{
...
/*   taujlambda= calc_muilambda(zj, energy_in, &abstabel);
   ...
   taujlambda=muzlambda[line_index][zj][lambda_index];
   tauilambda=muzlambda[line_index][zi][lambda_index];
   ...
   result=secijlambda(Cj, Jjlambda, omegaj, gj, Jilambdaj, Jilambda,
