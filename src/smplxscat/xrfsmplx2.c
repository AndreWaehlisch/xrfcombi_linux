...
*
*                    adapted for use with scatter calculations
*                    M.Bos
*                    Jan 24th 2004
*
*                    changed to use simplex again in
*                    2nd part with scatter
*                    April 12th 2004
**************************************************************************/
...
int main(int argc,char *argv[])
{
   ...
   rxi_calc2= malloc(nr_of_meas_lines* sizeof(double));
...
*/
   ...
   printf("================================================\n");
   printf("results with scattering taken into account\n");
   printf("================================================\n");


   /* setup new simplex for scatter */
     ...
     if (quad_test >=1 )
     {
       if (iter >= quad_test)
          ...
          if ( test <= quad_test)
              quad_test = quad_test/10 ;
     fflush(fpconverg);
     if ((iter > MAXSCATITERS)|| (test < exit_test)) break ;
   }

   fclose(fpconverg);

   if (iter > MAXSCATITERS) printf("Warning maximum # iterations in scatter reached \n");
   printf("\n");
   for (j=0; j < nr_of_meas_lines; j++)
   {
    printf("Line  %s %s RXI found %g RXI meas %g\n", 
