...
double intrasecflu_scat(char *meas_elem, char *meas_line, double lambda,
                   multilayer *sample, int nr_layer, double primint)
{
   ...
   for (i=0; i < nr_enh; i++)
   {
     ...
     tmpsecint=sijlambda_scat(meas_elem, el_enh, meas_line, line, player, lambda,
                         primint);
